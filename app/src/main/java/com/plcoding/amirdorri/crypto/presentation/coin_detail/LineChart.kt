package com.plcoding.amirdorri.crypto.presentation.coin_detail
...
//        val maxXLabelWidth = xLabelTextLayoutResults.maxOfOrNull { it.size.width } ?: 0
//        val maxXLabelHeight = xLabelTextLayoutResults.maxOfOrNull { it.size.height } ?: 0
//        val maxXLabelLineCount = xLabelTextLayoutResults.maxOfOrNull { it.size.height } ?: 0
...
//        //val valueIncrement = (maxYValue - minYValue) / labelCountExcludingLastLabel here
//        val valueIncrement = (maxYValue.toFloat() - minYValue.toFloat()) / labelCountExcludingLastLabel.toFloat()
//
//        val yLabels = (0..labelCountExcludingLastLabel).map {
//            ValueLabel(
//                //  value = maxYValue - (valueIncrement * it), here
//                value = maxYValue.toFloat() - (valueIncrement * it),
//                unit = unit
//            )
//        }
//        val yLabelTextLayoutResults = yLabels.map {
...
//                        y = viewPortTopY
//                    ),
//                    strokeWidth = if (selectedDataPointIndex == index) style.helperLineThicknessPx * 1.8f
...
//                val textPositionX = if (selectedDataPointIndex == visibleDataPointsIndices.last) {
//                    x - valueResult.size.width
//                } else x - valueResult.size.width / 2
//                val isTextInVisibleRange =
//                    (size.width - textPositionX).roundToInt() in 0..size.width.roundToInt()
//                if (isTextInVisibleRange){
//                    drawText(
